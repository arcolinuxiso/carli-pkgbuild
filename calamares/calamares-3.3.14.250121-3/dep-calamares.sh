...
sudo pacman -S --needed --noconfirm kdbusaddons
sudo pacman -S --needed --noconfirm appstream-qt
sudo pacman -S --needed --noconfirm ninja
sudo pacman -S --needed --noconfirm python-jsonschema
sudo pacman -S --needed --noconfirm python-pyaml
