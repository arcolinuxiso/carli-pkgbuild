...
set_target_properties(calamares PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcalamares.so.3.2.24-1"
  IMPORTED_SONAME_RELEASE "libcalamares.so.3.2.24-1"
  )

list(APPEND _IMPORT_CHECK_TARGETS calamares )
list(APPEND _IMPORT_CHECK_FILES_FOR_calamares "${_IMPORT_PREFIX}/lib/libcalamares.so.3.2.24-1" )
...
set_target_properties(calamaresui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libcalamaresui.so.3.2.24-1"
  IMPORTED_SONAME_RELEASE "libcalamaresui.so.3.2.24-1"
  )

list(APPEND _IMPORT_CHECK_TARGETS calamaresui )
list(APPEND _IMPORT_CHECK_FILES_FOR_calamaresui "${_IMPORT_PREFIX}/lib/libcalamaresui.so.3.2.24-1" )
