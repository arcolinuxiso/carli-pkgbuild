...
struct qt_meta_stringdata_NetInstallViewStep_t {
    QByteArrayData data[3];
    char stringdata0[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NetInstallViewStep_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NetInstallViewStep_t qt_meta_stringdata_NetInstallViewStep = {
    {
QT_MOC_LITERAL(0, 0, 18), // "NetInstallViewStep"
QT_MOC_LITERAL(1, 19, 11), // "nextIsReady"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "NetInstallViewStep\0nextIsReady\0"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_NetInstallViewStep[] = {
...
QT_INIT_METAOBJECT const QMetaObject NetInstallViewStep::staticMetaObject = { {
    ...
    qt_meta_stringdata_NetInstallViewStep.data,
    qt_meta_data_NetInstallViewStep,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *NetInstallViewStep::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NetInstallViewStep.stringdata0))
...
struct qt_meta_stringdata_NetInstallViewStepFactory_t {
    QByteArrayData data[1];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_NetInstallViewStepFactory_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_NetInstallViewStepFactory_t qt_meta_stringdata_NetInstallViewStepFactory = {
    {
QT_MOC_LITERAL(0, 0, 25) // "NetInstallViewStepFactory"
...
static const uint qt_meta_data_NetInstallViewStepFactory[] = {
...
QT_INIT_METAOBJECT const QMetaObject NetInstallViewStepFactory::staticMetaObject = { {
    ...
    qt_meta_stringdata_NetInstallViewStepFactory.data,
    qt_meta_data_NetInstallViewStepFactory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_NetInstallViewStepFactory.stringdata0))
        return static_cast<void*>(this);
