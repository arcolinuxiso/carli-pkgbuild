...
struct qt_meta_stringdata_SetKeyboardLayoutJob_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SetKeyboardLayoutJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SetKeyboardLayoutJob_t qt_meta_stringdata_SetKeyboardLayoutJob = {
    {
QT_MOC_LITERAL(0, 0, 20) // "SetKeyboardLayoutJob"
...
static const uint qt_meta_data_SetKeyboardLayoutJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject SetKeyboardLayoutJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_SetKeyboardLayoutJob.data,
    qt_meta_data_SetKeyboardLayoutJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SetKeyboardLayoutJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SetKeyboardLayoutJob.stringdata0))
