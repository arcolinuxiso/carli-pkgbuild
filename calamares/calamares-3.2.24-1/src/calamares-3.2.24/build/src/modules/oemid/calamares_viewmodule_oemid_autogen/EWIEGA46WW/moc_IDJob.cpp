...
struct qt_meta_stringdata_IDJob_t {
    QByteArrayData data[1];
    char stringdata0[6];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_IDJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IDJob_t qt_meta_stringdata_IDJob = {
    {
QT_MOC_LITERAL(0, 0, 5) // "IDJob"
...
static const uint qt_meta_data_IDJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject IDJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_IDJob.data,
    qt_meta_data_IDJob,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *IDJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IDJob.stringdata0))
