...
struct qt_meta_stringdata_ResizeVolumeGroupJob_t {
    QByteArrayData data[1];
    char stringdata0[21];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ResizeVolumeGroupJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ResizeVolumeGroupJob_t qt_meta_stringdata_ResizeVolumeGroupJob = {
    {
QT_MOC_LITERAL(0, 0, 20) // "ResizeVolumeGroupJob"
...
static const uint qt_meta_data_ResizeVolumeGroupJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject ResizeVolumeGroupJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_ResizeVolumeGroupJob.data,
    qt_meta_data_ResizeVolumeGroupJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ResizeVolumeGroupJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ResizeVolumeGroupJob.stringdata0))
