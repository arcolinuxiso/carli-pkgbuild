...
public:
    ...
    void setupUi(QDialog *CreatePartitionDialog)
    {
        ...
        formLayout->setWidget(4, QFormLayout::FieldRole, encryptWidget);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, mountPointComboBox);

        labelMountPoint = new QLabel(CreatePartitionDialog);
        labelMountPoint->setObjectName(QString::fromUtf8("labelMountPoint"));

        formLayout->setWidget(8, QFormLayout::FieldRole, labelMountPoint);
        ...
        formLayout->setWidget(9, QFormLayout::FieldRole, m_listFlags);
    ...
    void retranslateUi(QDialog *CreatePartitionDialog)
    {
        ...
        primaryRadioButton->setText(QCoreApplication::translate("CreatePartitionDialog", "&Primary", nullptr));
        ...
        labelMountPoint->setText(QString());
