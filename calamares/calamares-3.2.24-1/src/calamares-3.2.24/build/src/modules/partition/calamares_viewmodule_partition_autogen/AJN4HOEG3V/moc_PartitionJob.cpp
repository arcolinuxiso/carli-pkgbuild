...
struct qt_meta_stringdata_PartitionJob_t {
    QByteArrayData data[4];
    char stringdata0[32];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartitionJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartitionJob_t qt_meta_stringdata_PartitionJob = {
    {
QT_MOC_LITERAL(0, 0, 12), // "PartitionJob"
QT_MOC_LITERAL(1, 13, 9), // "iprogress"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 7) // "percent"

    },
    "PartitionJob\0iprogress\0\0percent"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_PartitionJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject PartitionJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_PartitionJob.data,
    qt_meta_data_PartitionJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartitionJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartitionJob.stringdata0))
