...
struct qt_meta_stringdata_ClearMountsJob_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ClearMountsJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ClearMountsJob_t qt_meta_stringdata_ClearMountsJob = {
    {
QT_MOC_LITERAL(0, 0, 14) // "ClearMountsJob"
...
static const uint qt_meta_data_ClearMountsJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject ClearMountsJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_ClearMountsJob.data,
    qt_meta_data_ClearMountsJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ClearMountsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClearMountsJob.stringdata0))
