...
struct qt_meta_stringdata_PartitionSplitterWidget_t {
    QByteArrayData data[3];
    char stringdata0[42];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartitionSplitterWidget_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartitionSplitterWidget_t qt_meta_stringdata_PartitionSplitterWidget = {
    {
QT_MOC_LITERAL(0, 0, 23), // "PartitionSplitterWidget"
QT_MOC_LITERAL(1, 24, 16), // "partitionResized"
QT_MOC_LITERAL(2, 41, 0) // ""

    },
    "PartitionSplitterWidget\0partitionResized\0"
    ""
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_PartitionSplitterWidget[] = {
...
void PartitionSplitterWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PartitionSplitterWidget::*)(const QString & , qint64 , qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PartitionSplitterWidget::partitionResized)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PartitionSplitterWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_PartitionSplitterWidget.data,
    qt_meta_data_PartitionSplitterWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartitionSplitterWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartitionSplitterWidget.stringdata0))
