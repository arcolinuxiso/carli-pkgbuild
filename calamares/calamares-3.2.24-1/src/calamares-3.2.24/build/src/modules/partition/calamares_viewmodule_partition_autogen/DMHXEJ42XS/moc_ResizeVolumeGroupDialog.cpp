...
struct qt_meta_stringdata_ResizeVolumeGroupDialog_t {
    QByteArrayData data[1];
    char stringdata0[24];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ResizeVolumeGroupDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ResizeVolumeGroupDialog_t qt_meta_stringdata_ResizeVolumeGroupDialog = {
    {
QT_MOC_LITERAL(0, 0, 23) // "ResizeVolumeGroupDialog"
...
static const uint qt_meta_data_ResizeVolumeGroupDialog[] = {
...
QT_INIT_METAOBJECT const QMetaObject ResizeVolumeGroupDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<VolumeGroupBaseDialog::staticMetaObject>(),
    qt_meta_stringdata_ResizeVolumeGroupDialog.data,
    qt_meta_data_ResizeVolumeGroupDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ResizeVolumeGroupDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ResizeVolumeGroupDialog.stringdata0))
