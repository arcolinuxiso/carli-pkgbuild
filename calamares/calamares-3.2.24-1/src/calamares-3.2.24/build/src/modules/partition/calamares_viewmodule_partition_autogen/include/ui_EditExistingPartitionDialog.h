...
public:
    ...
    void setupUi(QDialog *EditExistingPartitionDialog)
    {
        ...
        EditExistingPartitionDialog->resize(450, 579);
        ...
        formLayout->setWidget(6, QFormLayout::LabelRole, mountPointLabel);
        ...
        formLayout->setWidget(6, QFormLayout::FieldRole, mountPointComboBox);
        ...
        formLayout->setWidget(8, QFormLayout::FieldRole, m_listFlags);

        labelMountPoint = new QLabel(EditExistingPartitionDialog);
        labelMountPoint->setObjectName(QString::fromUtf8("labelMountPoint"));

        formLayout->setWidget(7, QFormLayout::FieldRole, labelMountPoint);
    ...
    void retranslateUi(QDialog *EditExistingPartitionDialog)
    {
        ...
        label_3->setText(QCoreApplication::translate("EditExistingPartitionDialog", "Content:", nullptr));
