...
struct qt_meta_stringdata_SetPartFlagsJob_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SetPartFlagsJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SetPartFlagsJob_t qt_meta_stringdata_SetPartFlagsJob = {
    {
QT_MOC_LITERAL(0, 0, 15) // "SetPartFlagsJob"
...
static const uint qt_meta_data_SetPartFlagsJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject SetPartFlagsJob::staticMetaObject = { {
    QMetaObject::SuperData::link<PartitionJob::staticMetaObject>(),
    qt_meta_stringdata_SetPartFlagsJob.data,
    qt_meta_data_SetPartFlagsJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SetPartFlagsJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SetPartFlagsJob.stringdata0))
