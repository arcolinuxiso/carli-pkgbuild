...
struct qt_meta_stringdata_PartitionSizeController_t {
    QByteArrayData data[4];
    char stringdata0[63];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartitionSizeController_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartitionSizeController_t qt_meta_stringdata_PartitionSizeController = {
    {
QT_MOC_LITERAL(0, 0, 23), // "PartitionSizeController"
QT_MOC_LITERAL(1, 24, 23), // "updatePartResizerWidget"
QT_MOC_LITERAL(2, 48, 0), // ""
QT_MOC_LITERAL(3, 49, 13) // "updateSpinBox"

    },
    "PartitionSizeController\0updatePartResizerWidget\0"
    "\0updateSpinBox"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_PartitionSizeController[] = {
...
QT_INIT_METAOBJECT const QMetaObject PartitionSizeController::staticMetaObject = { {
    ...
    qt_meta_stringdata_PartitionSizeController.data,
    qt_meta_data_PartitionSizeController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartitionSizeController::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartitionSizeController.stringdata0))
