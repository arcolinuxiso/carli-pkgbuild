...
struct qt_meta_stringdata_PartitionPage_t {
    QByteArrayData data[6];
    char stringdata0[123];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PartitionPage_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PartitionPage_t qt_meta_stringdata_PartitionPage = {
    {
QT_MOC_LITERAL(0, 0, 13), // "PartitionPage"
QT_MOC_LITERAL(1, 14, 23), // "updateFromCurrentDevice"
QT_MOC_LITERAL(2, 38, 0), // ""
QT_MOC_LITERAL(3, 39, 27), // "updateBootLoaderInstallPath"
QT_MOC_LITERAL(4, 67, 29), // "updateSelectedBootLoaderIndex"
QT_MOC_LITERAL(5, 97, 25) // "restoreSelectedBootLoader"

    },
    "PartitionPage\0updateFromCurrentDevice\0"
    "\0updateBootLoaderInstallPath\0"
    "updateSelectedBootLoaderIndex\0"
    "restoreSelectedBootLoader"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_PartitionPage[] = {
...
QT_INIT_METAOBJECT const QMetaObject PartitionPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_PartitionPage.data,
    qt_meta_data_PartitionPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PartitionPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PartitionPage.stringdata0))
