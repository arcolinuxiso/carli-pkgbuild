...
public:
    ...
    QCheckBox *checkBoxValidatePassword;
    ...
    void setupUi(QWidget *Page_UserSetup)
    {
        ...
        checkBoxValidatePassword = new QCheckBox(Page_UserSetup);
        checkBoxValidatePassword->setObjectName(QString::fromUtf8("checkBoxValidatePassword"));

        verticalLayout_12->addWidget(checkBoxValidatePassword);
    ...
    void retranslateUi(QWidget *Page_UserSetup)
    {
        ...
        textBoxUsername->setPlaceholderText(QCoreApplication::translate("Page_UserSetup", "login", nullptr));
        labelUsernameError->setText(QString());
        hostname_label_2->setText(QCoreApplication::translate("Page_UserSetup", "What is the name of this computer?", nullptr));
...
#if QT_CONFIG(tooltip)
        checkBoxValidatePassword->setToolTip(QCoreApplication::translate("Page_UserSetup", "When this box is checked, password-strength checking is done and you will not be able to use a weak password.", nullptr));
#endif // QT_CONFIG(tooltip)
        checkBoxValidatePassword->setText(QCoreApplication::translate("Page_UserSetup", "Require strong passwords.", nullptr));
        checkBoxAutoLogin->setText(QCoreApplication::translate("Page_UserSetup", "Log in automatically without asking for the password.", nullptr));
