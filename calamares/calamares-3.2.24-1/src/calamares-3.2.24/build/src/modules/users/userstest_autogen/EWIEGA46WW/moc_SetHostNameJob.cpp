...
struct qt_meta_stringdata_SetHostNameJob_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SetHostNameJob_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SetHostNameJob_t qt_meta_stringdata_SetHostNameJob = {
    {
QT_MOC_LITERAL(0, 0, 14) // "SetHostNameJob"
...
static const uint qt_meta_data_SetHostNameJob[] = {
...
QT_INIT_METAOBJECT const QMetaObject SetHostNameJob::staticMetaObject = { {
    QMetaObject::SuperData::link<Calamares::Job::staticMetaObject>(),
    qt_meta_stringdata_SetHostNameJob.data,
    qt_meta_data_SetHostNameJob,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SetHostNameJob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SetHostNameJob.stringdata0))
