...
QT_MOC_LITERAL(6, 84, 20), // "requirementsProgress"
QT_MOC_LITERAL(7, 105, 6) // "doInit"
...
void Calamares::ModuleManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->requirementsProgress((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->doInit(); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ModuleManager::requirementsProgress)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void Calamares::ModuleManager::requirementsProgress(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
