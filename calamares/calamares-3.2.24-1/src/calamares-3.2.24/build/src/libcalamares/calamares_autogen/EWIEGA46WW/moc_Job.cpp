...
struct qt_meta_stringdata_Calamares__Job_t {
    QByteArrayData data[4];
    char stringdata0[33];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Calamares__Job_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Calamares__Job_t qt_meta_stringdata_Calamares__Job = {
    {
QT_MOC_LITERAL(0, 0, 14), // "Calamares::Job"
QT_MOC_LITERAL(1, 15, 8), // "progress"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7) // "percent"

    },
    "Calamares::Job\0progress\0\0percent"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Calamares__Job[] = {
...
QT_INIT_METAOBJECT const QMetaObject Calamares::Job::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Calamares__Job.data,
    qt_meta_data_Calamares__Job,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Calamares::Job::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Calamares__Job.stringdata0))
